    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            <div class="card card-header text-center bg-gradient-success">
                <h1 class="h4 text-gray-900">{{ __('INSCRIPTION') }}</h1>
            </div>
            ...
            <div class="card-body">
                <form class="user" method="POST" action="{{ route('register') }}">
                    ...
                    {{-- <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="username" type="text" class="form-control  @error('username') is-invalid @enderror" name="username" placeholder="Votre username" value="{{ old('username') }}" autocomplete="username" autofocus>
