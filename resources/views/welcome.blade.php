...
<body class="home">
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			{{--  <div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><img src="assets/images/logo.png" alt="logo ADEBA"></a>
			</div>  --}}
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="active"><a href="{{ url('/sidebar-right') }}">Right Sidebar</a></li>
						</ul>
					</li>
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">BIENVENUE A BANDJIKAKY</h1>
	...
	<div class="jumbotron top-space">
		<div class="container">
			...
			<h3 class="text-center thin">Reasons to  this template</h3>
