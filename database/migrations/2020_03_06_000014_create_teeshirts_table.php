...
class CreateTeeshirtsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table->index(["participations_id"], 'fk_teeshirts_participations1_idx');
            $table->softDeletes();
            $table->nullableTimestamps();


            $table->foreign('participations_id', 'fk_teeshirts_participations1_idx')
