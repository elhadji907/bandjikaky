...
{ 
   ...
   public function __construct()
   {
    ...
    public function index()
    {
        ...
        return view('administrateurs.index', compact('generations'));
    }
    ...
    public function create()
    {
        $roles = Role::get();
        $generations = Generation::get();
        return view('administrateurs.create',compact('roles','generations'));
    }
    ...
    public function edit($id)
    {
        ...
        $roles = Role::get();
        return view('administrateurs.update', compact('administrateur','utilisateur','id','roles', 'generations'));
    }
